...
$www_input ='<input type="text" class="form_url_file" name="www_file" maxlength="400"'.$form_disabled.' onblur="check_input(this);" />'."\r\n";
} else {
$www_input = '';
}
...
<label>Показать трипкод: <input type="checkbox" name="show_tripcode" value="1" /></label><br />
</div>
</form>
';
...
<span class="info">'.$id_sec, $url, $post_time, $url_for, $ans.'</span>
</div>
';
}
